...
namespace BackEnd.Migrations
{
    ...
    [Migration("20230530043910_AddOrderToDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEnd.Entities.OrderAggregate.UserAddress", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackEnd.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "5bee29bc-8e7d-4480-8cfa-b604918225b7",
                            Name = "Member",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "0b516784-d26c-4c17-b5d7-3b19cabc0907",
                            Name = "Admin",
            ...
            modelBuilder.Entity("BackEnd.Entities.OrderAggregate.OrderItem", b =>
                {
                    ...
                    b.OwnsOne("BackEnd.Entities.OrderAggregate.ProductOrderItem", "ProductOrderItem", b1 =>
                        {
            ...
            modelBuilder.Entity("BackEnd.Entities.OrderAggregate.UserAddress", b =>
                {
                    b.HasOne("BackEnd.Entities.User", null)
                        .WithOne("UserAddress")
                        .HasForeignKey("BackEnd.Entities.OrderAggregate.UserAddress", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
